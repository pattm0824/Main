...
namespace WebApplication.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IGoalDAL>(m => new GoalSqlDAL(connectionString));
            services.AddTransient<IFoodDAL>(m => new FoodDAL(connectionString));
            services.AddTransient<IProgressDAL>(m => new ProgressDAL(connectionString));
            services.AddTransient<IWeightDAL>(m => new WeightDAL(connectionString));
